...
import Resume from "../../assets/ResumeUpdated1.1.pdf";
...
const Data = () => {
  return (
    <div className="home_data">
      ...
      <h3 className="home__subtitle">CS @University of Washington</h3>
      <p className="home__description">
        I'm a computer science student that is currently studying at the
        University of Washington in Seattle. Beyond programming, I'm really
        interested in embroidery and collecting stuff animals.{" "}
      </p>
